...
/// then triggers the action on the second tap (V3.0.3 bug fix).
///
...
/// («Добавить активность» / «Пригласить») — the screens where the user
/// reported the clipped-text bug.
...
class _MorphingFabState extends State<MorphingFab>
  ...
  Widget build(BuildContext context) {
    ...
    // (V3.0.3 fix), so we own the shape here.
